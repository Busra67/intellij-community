...
/**
 * Abstraction of painting API, this is used to define icons or graphics that are customizable but also reusable between
 * different environments, where graphic api differ.
 */
@ApiStatus.Internal
interface LayerPaintingContext {
    val offsetX: Int
    val offsetY: Int
    val slotWidth: Int?
    val slotHeight: Int?
