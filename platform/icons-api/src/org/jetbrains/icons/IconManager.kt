...
interface IconManager {
    ...
    fun addSwingLayer(designer: IconDesigner, legacyIcon: javax.swing.Icon, modifier: IconModifier)
    ...
    companion object {
        ...
        @ApiStatus.Internal
        fun modifiers(): ModifiersFactory {
            return getInstance().modifiersFactory()
        }

        @ApiStatus.Internal
        fun colorFilters(): ColorFilterFactory {
            return getInstance().colorFilterFactory()
        }

        @ApiStatus.Internal
        fun units(): UnitsFactory {
            return getInstance().unitsFactory()
        }
    }
}
