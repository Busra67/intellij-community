...
import org.jetbrains.icons.impl.modifiers.asFractionalPixels
...
class DefaultFitAreaScale(override val width: IconUnit, override val height: IconUnit, override val relative: Boolean) :
    ...
    override fun toString(): String {
        return "DefaultFitAreaScale(width=$width, height=$height, relative=$relative)"
    }
}
...
class DefaultFillAreaScale(
    ...
    override fun toString(): String {
        return "DefaultFillAreaScale(width=$width, height=$height, relative=$relative)"
    }
}
